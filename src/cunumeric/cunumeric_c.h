...
// Match these to BinaryOpCode in config.py
// Also, sort these alphabetically for easy lookup later
enum CuNumericQuantileOpCode {
  CUNUMERIC_QUANTOP_INV_CDF = 1,
  CUNUMERIC_QUANTOP_AVG_INV_CDF,
  CUNUMERIC_QUANTOP_CLOSEST_OBS,
  CUNUMERIC_QUANTOP_INTRP_INV_CDF,
  CUNUMERIC_QUANTOP_HAZEN,
  CUNUMERIC_QUANTOP_WEIBULL,
  CUNUMERIC_QUANTOP_LINEAR_INTRP,
  CUNUMERIC_QUANTOP_MEDIAN_UNBIASED,
  CUNUMERIC_QUANTOP_NORMAL_UNBIASED,
  CUNUMERIC_QUANTOP_LOWER_POINT,
  CUNUMERIC_QUANTOP_HIGHER_POINT,
  CUNUMERIC_QUANTOP_MID_POINT,
  CUNUMERIC_QUANTOP_NEAREST_POINT,
};
