...
if __name__ == "__main__":
    ...
    # qs_arr = np.array([0.001, 0.37, 0.42, 0.67, 0.83, 0.99, 0.39, 0.49 , 0.5]) # passes... except with arrays of dimension > 1 (e.g., arr2)
    #
    # qs_arr = np.array([0.001, 0.37, 0.42, 0.67, 0.83, 0.99, 0.39, 0.49]) # passed...
    ...
    arr = arr1 # passed...
    # qs_arr = np.array([0.001, 0.5]) # now fails for 0.001
