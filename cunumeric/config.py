...
class _CunumericSharedLib:
    ...
    CUNUMERIC_POTRF: int
    CUNUMERIC_QUANTILE: int
    CUNUMERIC_QUANTOP_INV_CDF: int
    CUNUMERIC_QUANTOP_AVG_INV_CDF: int
    CUNUMERIC_QUANTOP_CLOSEST_OBS: int
    CUNUMERIC_QUANTOP_INTRP_INV_CDF: int
    CUNUMERIC_QUANTOP_HAZEN: int
    CUNUMERIC_QUANTOP_WEIBULL: int
    CUNUMERIC_QUANTOP_LINEAR_INTRP: int
    CUNUMERIC_QUANTOP_MEDIAN_UNBIASED: int
    CUNUMERIC_QUANTOP_NORMAL_UNBIASED: int
    CUNUMERIC_QUANTOP_LOWER_POINT: int
    CUNUMERIC_QUANTOP_HIGHER_POINT: int
    CUNUMERIC_QUANTOP_MID_POINT: int
    CUNUMERIC_QUANTOP_NEAREST_POINT: int
    CUNUMERIC_RAND: int
    CUNUMERIC_READ: int
...
# Match these to CuNumericQuantileOpCode in cunumeric_c.h
@unique
class QuantileOpCode(IntEnum):
     INVERTED_CDF = _cunumeric.CUNUMERIC_QUANTOP_INV_CDF
     AVG_INVERTED_CDF = _cunumeric.CUNUMERIC_QUANTOP_AVG_INV_CDF
     CLOSEST_OBS = _cunumeric.CUNUMERIC_QUANTOP_CLOSEST_OBS
     INTRP_INVERTED_CDF = _cunumeric.CUNUMERIC_QUANTOP_INTRP_INV_CDF
     HAZEN = _cunumeric.CUNUMERIC_QUANTOP_HAZEN
     WEIBULL = _cunumeric.CUNUMERIC_QUANTOP_WEIBULL
     LINEAR_INTRP = _cunumeric.CUNUMERIC_QUANTOP_LINEAR_INTRP
     MEDIAN_UNBIASED = _cunumeric.CUNUMERIC_QUANTOP_MEDIAN_UNBIASED
     NORMAL_UNBIASED = _cunumeric.CUNUMERIC_QUANTOP_NORMAL_UNBIASED
     LOWER_POINT = _cunumeric.CUNUMERIC_QUANTOP_LOWER_POINT
     HIGHER_POINT = _cunumeric.CUNUMERIC_QUANTOP_HIGHER_POINT
     MID_POINT = _cunumeric.CUNUMERIC_QUANTOP_MID_POINT
     NEAREST_POINT = _cunumeric.CUNUMERIC_QUANTOP_NEAREST_POINT
